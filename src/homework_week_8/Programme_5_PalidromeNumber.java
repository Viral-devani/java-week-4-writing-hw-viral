 ...
 */
public class Programme_5_PalidromeNumber {
    public static boolean isPalidromeNumber(int number){
       //conver nagative number to  positive number
       if(number<0){
           number=-number;}
    ...
    public static void main(String[] args) {
        //scanner declaration reading from input from console
        Scanner scanner=new Scanner(System.in);
        System.out.println("Enter any number :");
        int a= scanner.nextInt();
        boolean check=isPalidromeNumber(a);
